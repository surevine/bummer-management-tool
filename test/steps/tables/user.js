...
module.exports = (function() {
    var library = helper.getLibrary()
        .when('I search (?:users|resources) for \'(.*)\'', function(user) {
        ...
        .when('I select to view ([0-9]*) [users|resources]', function(userCount) {
        ...
        .then('the user table has ([0-9]*) [users|resources]', function(expected) {
        ...
        .then('I do not see the (?:user|resource) search box', function() {
