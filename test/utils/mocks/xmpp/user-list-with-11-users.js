    ...
    return [
        ...
        },
        {
            ...
            response: function() {
                ...
                result.c('value').t('marvin@localhost')
                result.c('value').t('strickland@localhost')
                result.c('value').t('goldie@localhost')
                result.c('value').t('sherman@localhost')
                result.c('value').t('linda@localhost')
