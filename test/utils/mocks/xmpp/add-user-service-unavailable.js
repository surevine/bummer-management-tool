    ...
    return [
        {
              validator: function(stanza) {
                  ...
                  command.attrs.node.should.equal(Xmpp.USER_ADD)
                  ...
                  fields[0].getChildText('value').should.equal('mrstrickland@localhost')
                  fields[1].attrs.var.should.equal('password')
                  fields[1].getChildText('value').should.match(/[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{4}/i)
                  fields[2].attrs.var.should.equal('password-verify')
                  fields[2].getChildText('value').should.match(/[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{4}/i)
                  fields[1].getChildText('value').should.equal(fields[2].getChildText('value'))
              },
              response: function() {
